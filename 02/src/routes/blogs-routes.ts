...
blogsRoutes.post('/', authorization, checkErrorsBlog, (req: RequestWithBody<CreateBlogModel>,
...
blogsRoutes.get('/:id', (req: RequestWithParams<UriBlogModel>,
...
blogsRoutes.put('/:id', authorization, checkErrorsBlog, (req: RequestWithParamsAndBody<UriBlogModel, UpdateBlogModel>,
...
blogsRoutes.delete('/:id', authorization, (req: RequestWithParams<{ id: string }>,
                                                 res: Response<number>) => {
