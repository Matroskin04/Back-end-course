...
<p>Please, follow the link to finish your registration:<a href="https://www.youtube.com/?code=${code}">complete registration</a></p>` // todo перенести обработчик ошибок сюда
